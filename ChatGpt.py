...
def veritabanini_yukle():
    with open('C:\\Users\\Mali\\Desktop\\Projeler\\chatgpt\\veritabani.json','r') as dosya:
        return json.load(dosya)
    
def veritabanina_yaz(veriler):
    with open('C:\\Users\\Mali\\Desktop\\Projeler\\chatgpt\\veritabani.json','w') as dosya:
...
def chat_bot():
    ...
    while True:
        ...
        if gelen_sonuc:
            ...
            print("Bot : o kadarını söyleyemiyoruz maalesef")
            yeni_cevap = input("Cevabı söyleyebilir ya da geç yazarak yeni soruya geçebilirsiniz.")
